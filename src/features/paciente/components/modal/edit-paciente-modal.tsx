...
import { updatePaciente } from "@/app/(authenticated)/pacientes/action";
import {
  Form,
  FormControl,
  FormField,
...
export function EditPacienteModal({
  ...
  const { pacienteEditar, clearPacienteEditar } = usePacienteStore();
  const form = useForm<z.infer<typeof pacienteSchema>>({
    resolver: zodResolver(pacienteSchema),
    values: {
      birth_date: pacienteEditar.birth_date || "",
      cpf_cnpj: pacienteEditar.cpf_cnpj || "",
      email: pacienteEditar.email || "",
      name: pacienteEditar.name || "",
      phone: pacienteEditar.phone || "",
      active: pacienteEditar.active || true,
    },
  });
